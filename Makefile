...
am_FBF_Optics_OBJECTS = src/main.$(OBJEXT) src/fbfoptics.$(OBJEXT) \
	src/spr.$(OBJEXT) src/ewe.$(OBJEXT) src/layer.$(OBJEXT) \
	src/xmlparse.$(OBJEXT)
...
FBF_Optics_SOURCES = src/main.cc src/fbfoptics.cc src/spr.cc src/ewe.cc src/layer.cc src/xmlparse.cc include/spr.hpp include/layer.hpp include/expm.hpp include/fbfoptics.hpp include/xmlparse.hpp
all: config.h
...
src/ewe.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
